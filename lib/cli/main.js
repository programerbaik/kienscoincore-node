...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `kienscoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ kienscoincore-node add wallet-service');
      console.log('    $ kienscoincore-node add kienscoin-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ kienscoincore-node remove wallet-service');
      console.log('    $ kienscoincore-node remove kienscoin-api');
      console.log();
    });
